    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li><a href="./satuan.php"><i class="fa fa-balance-scale"></i> <span>Units</span></a></li>
          <li><a href="./register.php"><i class="fa fa-users"></i> <span>Manage Users</span></a></li>
          <li><a href="./product.php"><i class="fa fa-archive"></i> <span>{Products}</span></a></li>
          <li><a href="./order.php"><i class="fa fa-shopping-cart"></i> <span>Transaction</span></a></li>
          <li><a href="report_sales.php"><i class="fa fa-newspaper-o"></i> <span>Reports</span></a></li>
        </ul>
        <!-- /.sidebar-menu -->
      </section>
      <!-- /.sidebar -->
